...
class MathBoolOpTests: XCTestCase {
    ...
    // #1
    func testAdd() {
        let result = test.addAB(a: 5, b: 5)
        let result2 = test.addAB(a: 0, b: -3)
    ...
    func testAddWithIntAndDouble() {
        let result = test.addAB2(a: 5, b: 25.5)
        let result2 = test.addAB2(a: 1, b: 99.9)
